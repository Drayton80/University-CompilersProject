...
class TypeControlStack:
    ...
    def check_relational(self):
        if self.get_top() == 'integer' and self.get_subtop() == 'integer':
            ...
            self.update('boolean')
        elif self.get_top() == 'char' and self.get_subtop() == 'char':
            self.update('boolean')
        elif self.get_top() == 'string' and self.get_subtop() == 'string':
            self.update('boolean')
        elif self.get_top() == 'boolean' and self.get_subtop() == 'boolean':
            self.update('boolean')
        else:
